...
import net.mready.dicejava.ui.history.HistoryEmptyFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void navigateToHistoryEmpty() {
        Fragment existingFragment = getSupportFragmentManager().findFragmentByTag(HistoryEmptyFragment.class.getSimpleName());

        if (existingFragment != null) {
            getSupportFragmentManager().popBackStack(existingFragment.getClass().getSimpleName(), FragmentManager.POP_BACK_STACK_INCLUSIVE);
        } else {
            loadFragment(HistoryEmptyFragment.newInstance(), true);
        }
    }
